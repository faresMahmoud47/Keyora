...
addPropertyBtn.addEventListener("click", function () {
    ...
    reader.onload = function () {
        ...
        // البيانات الخاصة بالفلترة
        propertyCard.dataset.type = type;
        propertyCard.dataset.operation = operation;
        propertyCard.dataset.price = price;
        propertyCard.dataset.location = location;
...
detailsBtn.dataset.name = name;
detailsBtn.dataset.image = imageURL;
detailsBtn.dataset.longDesc = longDesc;
detailsBtn.dataset.operation = operation;
...
propertiesContainer.addEventListener("click", function (e) {
    ...
    let modal =
        bootstrap.Modal.getOrCreateInstance(propertyModal);
